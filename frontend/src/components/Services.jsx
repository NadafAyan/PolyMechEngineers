      ...
      <div className="bg-[#EEF6FA] min-h-screen px-6 py-10 pt-28 max-w-[1440px] mx-auto">
        ...
        <div className="grid md:grid-row-3 grid-row-6 gap-y-5">
          <div className="grid md:grid-cols-5 gap-4">
            {/* row 1 */}
            {/* col 1 */}
            <div className="relative bg-black rounded-2xl overflow-hidden h-110 group delay-300  md:col-span-2 transition-all duration-500lg:hoverscale-103">
              <img
                src={image3}
                alt="prototypes"
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 scale-75 z-10 transition-all duration-500 delay-300 
              ...
              <div className="absolute inset-0 flex flex-wrap items-end delay-300 justify-start md:pb-66 pb-83 md:pl-60 pl-45 opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 z-30">
            ...
            {/* col 2 */}
            <div className="relative bg-black rounded-2xl h-110 overflow-hidden md:col-span-3 group transition-all duration-500 delay-300lg:hoverscale-103">
              <img
                src={image4}
                alt="prototypes"
              ...
              >
                <p className="text-white md:text-5xl text-5xl font-bold text-center">
                  Casting Components
                </p>
              </div>
              ...
              md:group-hover:translate-x-[13%] md:group-hover:translate-y-[-24%]"
                style={textStyle}
              >
                <p className="text-transparent border-2 md:text-5xl text-5xl font-bold text-center">
                  Casting Components
                </p>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {/* col 1 */}
            <div className="relative bg-black rounded-2xl max-w-[1400px] overflow-hidden h-110 group delay-300 transition-all duration-500 lg:hoverscale-103">
              <img
                src={image1}
                alt="prototypes"
              ...
              <div className="absolute inset-0 flex items-center justify-center group">
                <p className="text-white md:text-6xl text-5xl font-bold text-center z-0 delay-300 transition-all duration-500 md:group-hover:translate-x-[35%] md:group-hover:translate-y-[-200%]">
                  Prototypes
                </p>

                <p
                  style={textStyle}
                  className="absolute text-transparent border-2 md:text-6xl text-5xl font-bold text-center z-20 delay-300 transition-all duration-500 md:group-hover:translate-x-[34.6%] md:group-hover:translate-y-[-190%]"
                >
                  Prototypes
                </p>

                <div className="absolute inset-0 flex flex-wrap items-end delay-300 justify-start md:pb-65 md:pl-73 opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 z-30">
            ...
            {/* col 2 */}
            <div className="relative bg-black rounded-2xl overflow-hidden h-110 group delay-300 transition-all duration-500lg:hoverscale-103">
              <img
                src={image2}
                alt="prototypes"
              ...
              <div className="absolute inset-0 flex items-center justify-center z-0 group">
                <p className="text-white text-6xl font-bold text-center z-0 delay-300 transition-all duration-500 md:group-hover:translate-x-[24%] md:group-hover:translate-y-[-240%]">
                  EV Parts
                </p>
              </div>
              ...
              <div className="absolute inset-0 flex flex-wrap items-end delay-300 justify-start pb-68 pl-70 opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 z-30">
                <p className="text-white text-xl font-bold">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {/* col 1 */}
            <div className="relative bg-black h-110 rounded-2xl overflow-hidden group transition-all duration-500 delay-300lg:hoverscale-103">
              <img
                src={image5}
                alt="prototypes"
                ...
                md:group-hover:scale-53 md:group-hover:top-34 md:group-hover:left-32"
              />
              ...
              <div className="absolute inset-0 flex flex-wrap items-end delay-300 justify-start pb-68 pl-71 opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 z-30">
                <p className="text-white text-xl font-bold">
